      ...
      "columnDefs": [
        {
          ...
          "render": function (data, type, row) {
            return '<a class="btn btn-primary btn-xs" href="patients/dispense/' + row['ccc_number'] + '">Dispense</a> <a class="btn btn-primary btn-xs" href="patients/view/' + row['ccc_no'] + '">Detail</a>'
          },
